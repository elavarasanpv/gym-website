...
const Home = ({setSelectedPage}: Props) => {
 const isAboveMediumScreeen = useMediaQuery("(min-width: 1060px)")
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0 md:flex md:flex-col">

        <motion.div className='md:flex mx-auto w-5/6 items-center justify-center md:5/6 md:flex-1'
            ...
            <div className='z-10 mt-32 md:basis-3/5'>
                ...
                variants={{hidden: {opacity: 0, x: -50}, visible: {opacity: 1, x: 0}}}>
                    <div className='relative'>
                        <div className='before:absolute md:before:-top-20 before:-left-20  before:content-left md:before:content-evolvetext before:opacity-70 before:z-[-40]'>
